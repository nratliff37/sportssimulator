...
def create_teams():
    teams_file = open("mfl_teams.txt", "r")
...
try:
    file_path = ".\mfl_schedule_" + schedule_ext + ".txt"
    schedule_file = open(file_path, "r")
except:
    print("mfl_schedule_" + schedule_ext + ".txt is missing. Exiting program...")
    exit()
...
if not test:
    ...
    output_name = "mfl_team_records_" + str(time_stamp) + ".txt"
    ...
    output_name = "mfl_game_results_" + str(time_stamp) + ".txt"
